...
class JsonConvert<T> {
    ...
    switch (type) {			case MatrixEntity:
			...
			return matrixDataCornerFromJson(data as MatrixDataCorner, json) as T;			case IndexEntity:
    ...
    return data as T;
		...
		switch (type) {			case MatrixEntity:
			...
			return matrixDataCornerToJson(data as MatrixDataCorner);			case IndexEntity:
    ...
    switch (T.toString()) {			case 'MatrixEntity':
			...
			return MatrixDataCorner().fromJson(json) as T;			case 'IndexEntity':
